...
- code
    ...
    - finetuning_literal_fluent_translations: directory with code for finetuning English RoBERTa model on literal/fluent translated tweets
        - without_hyperparameter_tuning.ipynb
            code for finetuning without hyperparameter tuning
        - with_hyperparameter_tuning.ipynb
            code for finetuning with hyperparameter tuning
...
- results
    ...
    - finetuning_literal_fluent_results: directory with detailed metrics and confusion matrices for results of finetuning English RoBERTa model on literal/fluent translated tweets
        - without_hyperparameter_tuning.ipynb
            results from finetuning without hyperparameter tuning
        - with_hyperparameter_tuning.ipynb
            results from finetuning with hyperparameter tuning
